...
export type ThemeId = "nobc" | "midnight" | "obsidian" | "rose"
...
export function isThemeId(value: unknown): value is ThemeId {
  return value === "nobc" || value === "midnight" || value === "obsidian" || value === "rose"
}
...
export const THEME_INIT_SCRIPT = `(function(){try{var t=localStorage.getItem('${THEME_STORAGE_KEY}');if(t==='nobc'||t==='midnight'||t==='obsidian'||t==='rose'){document.documentElement.dataset.theme=t;}}catch(e){}})();`
