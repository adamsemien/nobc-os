...
export type ThemeId = "nobc" | "midnight" | "obsidian" | "rose" | "parchment" | "void" | "ember" | "y2k" | "aim" | "myspace" | "editorial"
...
export function isThemeId(value: unknown): value is ThemeId {
  return value === "nobc" || value === "midnight" || value === "obsidian" || value === "rose" || value === "parchment" || value === "void" || value === "ember" || value === "y2k" || value === "aim" || value === "myspace" || value === "editorial"
}
...
export const THEME_INIT_SCRIPT = `(function(){try{var t=localStorage.getItem('${THEME_STORAGE_KEY}');var valid=['nobc','midnight','obsidian','rose','parchment','void','ember','y2k','aim','myspace','editorial'];if(valid.indexOf(t)!==-1){document.documentElement.dataset.theme=t;}}catch(e){}})();`
