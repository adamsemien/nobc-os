...
export const SPONSOR_TARGETS: SponsorTarget[] = [
  ...
  },
  {
    ...
    targetArchetypes: ['Sage', 'Host', 'Patron'],
    primaryArchetype: 'Sage',
    charterWeighted: true,
  ...
  },
  {
    ...
    targetArchetypes: ['Sage', 'Connector'],
    primaryArchetype: 'Connector',
    charterWeighted: false,
