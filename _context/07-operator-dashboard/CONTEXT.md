...
app/operator/_components/BackRoomEasterEgg.tsx           ← The Back Room easter egg: typed-knock trigger, door cinematic, WebAudio lo-fi engine, Darkroom swap (client-only; honors prefers-reduced-motion)
