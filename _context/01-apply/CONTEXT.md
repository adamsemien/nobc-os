...
| Field | Value |
|---|---|
| **State** | ✅ Shipped — live at `/apply` · 🟡 full rebuild + editorial redesign + flow overhaul (6 chapter-pages, global progress bar, localStorage resume, speech-to-text dictation) on branch `feat/apply-rebuild-redesign` (not merged) · (+ application-backup feature code-complete, dormant on a branch) |
| **V1 item** | #1, #5 |
