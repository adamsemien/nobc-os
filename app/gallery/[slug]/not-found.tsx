/**
 * Local 404 for the member-gallery share route. Rendered by Next.js when a
 * page-level `notFound()` is thrown — terminal failure modes (NOT_FOUND /
 * EXPIRED / FOLDER_DELETED) collapse to this state. Editorial-minimal,
 * branded chrome.
 */
...
export default function NotFound() {
  return (
    <div className="flex min-h-screen flex-col bg-events-paper text-[var(--apply-ink)]">
      <ShareHeader title="This share link is no longer available" kicker="Member Gallery" />
